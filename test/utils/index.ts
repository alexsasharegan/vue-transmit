...
import { Vue as VueComponent } from "vue/types/vue"
import VueTransmit from "../../index"
...
window.Vue = Vue
window.Vue.use(VueTransmit)

const fixtureDir = resolve(__dirname, "fixtures")

export function loadFixture(name) {
	let template = readFileSync(resolve(fixtureDir, name, "index.html"), "utf8")
	let js = readFileSync(resolve(fixtureDir, name, "index.js"), "utf8")
